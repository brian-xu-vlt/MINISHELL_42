...
int		main()
{
	...
	tester("echo \"bip | bip ; coyotte > < \" \" . bip | bip ; coyotte >< \"", "WORD@echo#\"@\"bip | bip ; coyotte > <\"#\"@\" . bip | bip ; coyotte >< \"");
	tester("export var =\"cat Makefile | grep >\" . ", "WORD@echo#WORD@var#WORD@=#\"@cat Makefile | grep >\"#WORD@.");
	tester("export \"test=ici\"=coucou . test=ici=coucou", "WORD@export#\"@test=ici\"#=@=coucou#WORD@.#=@test=ici=coucou");
	...
	tester("export \"HI= hi\"", "WORD@export#\"@\"HI= hi\"");
	tester("export \"HI =hi\"", "WORD@export#\"@HI =hi\"");
	tester("echo $?", "WORD@echo#$@$?");
	tester("| echo", "|#WORD@echo");
	tester("echo |", "WORD@echo#|");
	...
	tester("test \"$var\" = \"Hello world !\"", "WORD@test#\"@\"$var\"#=#\"@\"Hello world !\"");
	tester("test \"num1\" [-eq|-ne|-gt|-lt] \"num2\"", "WORD@test#\"@\"num1\"#WORD@[-eq#|#WORD@-ne#|#WORD@-gt#|#WORD@-lt]#\"@\"num2\"");
	tester("test \"$var\" -eq \"1\"", "WORD@test#\"@\"$var\"#WORD@-eq#\"@\"1\"");
	tester("test \"1\" = \"1\"", "WORD@test#\"#\"@\"1\"#WORD@=#\"#\"@\"1\"");
	tester("var1=1+1", "=@var1=1+1");
	tester("let $var1", "WORD@let#$@$var1");
	tester("var=$((5*3))", "=@var=$((5*3))");
	tester("test -e /etc/passwd && echo \"Le fichier existe\" || echo \"Le fichier n'existe pas\"", "WORD@test#WORD@-e#WORD@/etc/passwd#&&#WORD@echo#\"@\"Le fichier existe\"#||#WORD@echo#\"@\"Le fichier n'existe pas\"");
	tester("=====","WORD@=====");
	tester("=","WORD@=");
